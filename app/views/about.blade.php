...
@section('content')
	<div class="col-md-6 col-md-offset-3">
		...
		<hr />
		<p class="lead">
			<strong>Redditing&trade;</strong> is a <a href="https://reddit.com" target="_blank" rel="nofollow"><strong>reddit</strong></a> browser made to simplify browsing reddit using various API's and visual improvements.
		    <br />
		    <br />
		    ...
		    <br />
		    <br />
		    You can read more about the project on <a href="{{ URL::to('r/readditingcom') }}"><strong>Redditing.com</strong></a> subreddit.
	    </p>
