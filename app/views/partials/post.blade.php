	<div infinite-scroll='reddit.nextPage()' infinite-scroll-disabled='reddit.busy' infinite-scroll-distance='1'>
		<div class="img-responsive img-rounded block-centered">
			<img src="http://placehold.it/290x80" />
		</div>
			...
			<div class="panel-footer" ng-if="post.author">
				<div class="row">
					...
					<div class="col-sm-4 text-center">
						<button ng-click="comments(post)" class="btn btn-link"><i class="fa fa-comment-o"></i> <% post.comments %> comments</button>
					</div>
					@if(Session::has('user'))
