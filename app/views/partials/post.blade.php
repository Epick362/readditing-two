		...
		<div class="panel panel-default" ng-class="(post.nsfw) ? 'nsfw' : ''" ng-repeat="post in reddit.posts">
			<div class="upvote-wrapper hidden-sm hidden-xs" ng-if="post.author">
				<div class="upvote-container">
					<!-- Upvote -->
					<span ng-if="post.likes == null || post.likes == false">
					...
					<!-- Downvote -->
					<span ng-if="post.likes == null || post.likes == true">
					...
					<p class="text-center" style="margin-top:5px"><% post.score %></p>
