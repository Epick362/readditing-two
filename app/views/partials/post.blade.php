	<div infinite-scroll="reddit.nextPage('{{ Input::get('after', '') }}')" infinite-scroll-disabled="reddit.busy" infinite-scroll-distance="0" infinite-scroll-immediate-check="1">
			...
			<div class="panel-footer" ng-if="post.author">
				<div class="row">
					...
					<div class="col-sm-4 text-center">
						<a href="" ng-click="comments(post)" class="btn-showcomments"><i class="fa fa-comment-o"></i> <% post.comments %> comments</a>
					</div>
					@if(Session::has('user'))
